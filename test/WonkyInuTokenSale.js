...
contract('WonkyInuTokenSale', function(accounts) {
  var tokenInstance;
  ...
  it('initializes the contract with the correct values', function() {
    return WonkyInuTokenSale.deployed().then(function(instance) {
  ...
  it('facilitates token buying', function() {
    return WonkyInuToken.deployed().then(function(instance) {
      ...
      return WonkyInuTokenSale.deployed();
  ...
  it('ends token sale', function() {
    return WonkyInuToken.deployed().then(function(instance) {
      ...
      assert.equal(balance.toNumber(), 999990, 'returns all unsold WonkyInutokens to admin');
